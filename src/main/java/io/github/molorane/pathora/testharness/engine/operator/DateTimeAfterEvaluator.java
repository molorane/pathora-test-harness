...
public class DateTimeAfterEvaluator implements AssertionEvaluator {
    ...
    public void apply(String path, Object actual, Object expected, boolean pathExists) {
        ...
        LocalDateTime actualDt = DateTimeBeforeEvaluator.parseDateTime(String.valueOf(normalizedActual), path);
        LocalDateTime expectedDt = DateTimeBeforeEvaluator.parseDateTime(String.valueOf(expected), path);
