...
public class MoneyEqualsEvaluator implements AssertionEvaluator {

    @Override
    public AssertionOperator operator() {
        return AssertionOperator.MONEY_EQUALS;
    }
    ...
    public void apply(String path, Object actual, Object expected, boolean pathExists) {
        ...
        MoneyUtils.validateCurrencyMatch(path, normalizedActual, expected, AssertionOperator.MONEY_EQUALS);
