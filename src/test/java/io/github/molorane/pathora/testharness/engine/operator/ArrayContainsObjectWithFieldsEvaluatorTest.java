...
class ArrayContainsObjectWithFieldsEvaluatorTest {

    private ArrayContainsObjectWithFieldsEvaluator operator;

    @BeforeEach
    void setUp() {
        operator = new ArrayContainsObjectWithFieldsEvaluator();
    }
